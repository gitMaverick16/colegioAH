    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="quinto.png" style="width:90%" class="center" alt="Avatar">
          <div class="w3-display-bottomleft w3-container w3-text-black">
          </div>
        </div>        <div class="w3-container">
         <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large"></i>Tutora</p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large"></i>EVERT EDUARDO CARDENAS CARDENAS</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large font size="1"></i>tutor.5to.grado@albertohidalgo.edu.pe</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large"></i>964220581</p>
           <hr>
...
<thead>
	...
	<tbody>
		 <tr>
            ...
            <td class="tg-h9da"><a href="https://aprendiendoencasaconlibertad.blogspot.com/">TUTOR/ÁREAS</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Quinto Grado</a></td>
          </tr>
          
           <tr>
            <td class="tg-omgv">JUAN VÍCTOR CACERES FALLA</td>
            <td class="tg-h9da"><a href="https://juanvcfalla.blogspot.com/">Matemática de Quinto Grado</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Quinto Grado</a></td>
          </tr>
      
       <tr>
             <td class="tg-omgv">EVERT EDUARDO CARDENAS CARDENAS</td>
            <td><a href="https://aprendiendoencasaconlibertad.blogspot.com/">Inglés de Quinto Primaria</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Inglés de Quinto Grado</a></td>

          </tr>
          <tr>
            <td class="tg-lboi">ELIZABETH MORALES MUÑOZ</td>
            <td class="tg-uzvj"><a href="https://tecnologiaieah5to.blogspot.com/">Tecnología de Quinto Primaria</td>
          	<td><a href="">Haz click aquí para ir al ZOOM de Tecnología de Quinto Grado</a></td>

          </tr>
          <tr>
            <td class="tg-omgv">ELARD ARTURO COASACA ALARCON</td>
            <td class="tg-uzvj"><a href="https://elarturo21.blogspot.com/">ED. FÍSICA</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Ed. Física de Quinto Grado</a></td>

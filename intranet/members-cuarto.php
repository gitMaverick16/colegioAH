    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="cuarto.png" style="width:90%" class="center" alt="Avatar">
          <div class="w3-display-bottomleft w3-container w3-text-black">
          </div>
        </div>        <div class="w3-container">
         <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large"></i>Tutora</p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large"></i>LISSETT MARCELA SILVA NUÑEZ</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large font size="1"></i>tutor.4to.grado@albertohidalgo.edu.pe</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large"></i>+51 902 281 572</p>
           <hr>
...
<table class="flat-table flat-table-2"width: 30%; >
	...
	<tbody>
		 <tr>
            ...
            <td class="tg-h9da"><a href="http://lissettsn.blogspot.com/">TUTORA/ÁREAS</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Cuarto Grado</a></td>

          </tr>
		<tr>
               <td class="tg-omgv">EVERT EDUARDO CARDENAS CARDENAS</td>
            <td><a href="https://aprendiendoencasaconlibertad.blogspot.com/">INGLÉS 4° Primaria</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Inglés de Cuarto Grado</a></td>

          </tr>
          <tr>
            <td class="tg-lboi">ELIZABETH MORALES MUÑOZ</td>
            <td class="tg-uzvj"><a href="https://tecnologiaieah4to.blogspot.com/">TECNOLOGÍA 4° PRIMARIA</td>
          	<td><a href="">Haz click aquí para ir al ZOOM de Tecnología de Cuarto Grado</a></td>

          </tr>
          <tr>
            <td class="tg-omgv">ELARD ARTURO COASACA ALARCON</td>
            <td class="tg-uzvj"><a href="https://elarturo21.blogspot.com/">ED. FÍSICA</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de Ed. Física de Cuarto Grado</a></td>

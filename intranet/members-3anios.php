    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="3anios.png" style="width:90%" class="center" alt="Avatar">
          <div class="w3-display-bottomleft w3-container w3-text-black">
          </div>
        </div>        <div class="w3-container">
         <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large"></i>Tutora</p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large"></i>VIVIANA LIBIA CHAUCHA PALMA</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large font size="1"></i>tutor.inicial.3@albertohidalgo.edu.pe</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large"></i>950310707</p>
           <hr>
...
<table class="flat-table flat-table-2"width: 90%; >
 <img src="jardin.PNG" style="width:85%" class="center" alt="Avatar">
	<thead>
		<th><b>Docente</b></th>
	...
	<tbody>
		 <tr>
            <td class="tg-omgv">VIVIANA LIBIA CHAUCHA PALMA</td>
            <td class="tg-h9da"><a href="https://missvivicolegio.blogspot.com/">TUTORA/ÁREAS</td>
        	<td><a href="">Haz click aquí para ir al ZOOM de 3 años</a></td>
...
<table class="flat-table flat-table-2"width: 30%; >
	...
	<tbody>
		<tr>
			...
			&nbsp &nbsp 
		</td>			<td class="tg-hw4h"><a href="https://albertohidalgo.edu.pe/intranet/anexo1.html" target="_blank">Enlace al ANEXO 1</a></td>
